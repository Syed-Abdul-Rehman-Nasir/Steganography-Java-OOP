...
//       getMaximumWindowBounds());
    ...
    private java.io.File showFileDialog(final boolean open) {
        ...
        javax.swing.filechooser.FileFilter ff = new javax.swing.filechooser.FileFilter() { // specifies which files are accpetable for selection
    ...
    private void embedMessage(BufferedImage img, String mess) {
        ...
        if(messageLength * 8 + 32 > imageSize) {// integers are typically 32 bits in Java
    ...
    private void embedInteger(BufferedImage img, int n, int start, int storageBit) {
        ...
        for(int i=startX; i<maxX && count<32; i++) {//The number of bits embedded is limited to 32 (count < 32), as integers are typically 32 bits in Java.
